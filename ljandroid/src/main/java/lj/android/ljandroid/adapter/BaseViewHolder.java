...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setImageLoadUrl(Context context,int viewId, int id){
        ImageView view = getView(viewId);
        view.setImageResource(id);
        return this;
    }
    public SimpleDraweeView setWebImageUrl( int viewId, String url, int wight,int hight){
        SimpleDraweeView view = getView(viewId);
        LJTools.showPxFrescoImage(view,url,wight,hight);
        return view;
    }
    public SimpleDraweeView setResImageUrl( int viewId, int id, int wight,int hight){
        SimpleDraweeView view = getView(viewId);
        LJTools.loadResDroderImage(view,id,wight,hight);
        return view;
    }
    public SimpleDraweeView setAsstImageUrl( int viewId, String url, int wight,int hight){
        SimpleDraweeView view = getView(viewId);
        LJTools.loadAssetDroderImage(view,url,wight,hight);
        return view;
    }
    /**
