...
package lj.android.ljandroid.adapter;
...
import lj.android.ljandroid.adapter.animation.AlphaInAnimation;
import lj.android.ljandroid.adapter.animation.BaseAnimation;
import lj.android.ljandroid.adapter.animation.ScaleInAnimation;
import lj.android.ljandroid.adapter.animation.SlideInBottomAnimation;
import lj.android.ljandroid.adapter.animation.SlideInLeftAnimation;
import lj.android.ljandroid.adapter.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    **/
    ...
    public void addFooterView(View footer) {
        LogUtil.i("getFooterLayout()-->>"+getFooterLayout());
        if(getFooterLayout()==null)   {
            setloadFinshView(footer);
            addFooterView(footer, -1);
        }

    }
    public void setloadFinshView(View view)
    {
        loadFinshView=view;
    }
    public View getloadFinshView()
    {
        return loadFinshView;
    }
    /**
            ...
            if (mOpenAnimationEnable) {
                ...
                if (!mFirstOnlyEnable || holder.getLayoutPosition() > mLastPosition) {
                    ...
                    for (Animator anim : animation.getAnimators(holder.itemView)) {
                        ...
                        Log.d(TAG, "startAnim: "+anim);
                    }
                    Log.d(TAG, "addAnimation: "+holder.getLayoutPosition()+"mlast"+mLastPosition);
