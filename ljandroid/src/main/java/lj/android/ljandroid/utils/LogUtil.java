...
import lj.android.ljandroid.config.LjConfig;

/**
 * todo 日志开关
 * Created by liujie on 16/5/1.
 */
public class LogUtil {
    
    public static String customTagPrefix = "liujie";  // 自定义Tag的前缀，可以是作者名
    private static final boolean Is_LOG=true;//是否打开日志
    public static boolean isSaveLog = Is_LOG;    // 是否把保存日志到SD卡中
    public static final String LOG_PATH = LjConfig.cacheFilePath; // SD卡中的根目录
    ...
    public static boolean allowD = Is_LOG;
    public static boolean allowE = Is_LOG;
    public static boolean allowI = Is_LOG;
    public static boolean allowV = Is_LOG;
    public static boolean allowW = Is_LOG;
    public static boolean allowWtf = Is_LOG;
    ...
    public static void point(String path, String tag, String msg) {
        if (isSDAva()) {
            ...
            try {
                ...
                out.write(LJTools.getStrTime(String.valueOf(timestamp),0)+ " " + tag + " " + msg + "\r\n");
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
                try {
