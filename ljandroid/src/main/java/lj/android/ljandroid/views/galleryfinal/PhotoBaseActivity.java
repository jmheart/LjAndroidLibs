...
import lj.android.ljandroid.views.galleryfinal.utils.MediaScanner;
...
public abstract class PhotoBaseActivity extends Activity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       cn.finalteam.toolsfinal.ActivityManager.getActivityManager().addActivity(this);
    ...
    protected void onDestroy() {
        ...
        cn.finalteam.toolsfinal.ActivityManager.getActivityManager().finishActivity(this);
    }
    ...
    protected void takePhotoAction() {
        ...
        boolean suc = cn.finalteam.toolsfinal.io.FileUtils.mkdirs(takePhotoFolder);
        File toFile = new File(takePhotoFolder, "IMG" + cn.finalteam.toolsfinal.DateUtils.format(new Date(), "yyyyMMddHHmmss") + ".jpg");
    ...
    private void finishGalleryFinalPage() {
        cn.finalteam.toolsfinal.ActivityManager.getActivityManager().finishActivity(PhotoEditActivity.class);
        cn.finalteam.toolsfinal.ActivityManager.getActivityManager().finishActivity(PhotoSelectActivity.class);
