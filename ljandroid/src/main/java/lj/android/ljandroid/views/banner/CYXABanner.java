...
import lj.android.ljandroid.views.banner.transformer.BGAPageTransformer;
import lj.android.ljandroid.views.banner.transformer.TransitionEffect;


public class CYXABanner extends RelativeLayout implements CYXAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    private static final int RMP = LayoutParams.MATCH_PARENT;
    private static final int RWC = LayoutParams.WRAP_CONTENT;
    private static final int LWC = LinearLayout.LayoutParams.WRAP_CONTENT;
    private static final int NO_PLACEHOLDER_DRAWABLE = -1;
    private static final int VEL_THRESHOLD = 400;
    private CYXAViewPager mViewPager;
    ...
    private int mPointDrawableResId = R.drawable.ic_gf_default_photo;
    ...
    private boolean mIsIndicatorVisibility=true;
    private View mSkipView;
    private View mEnterView;

    public CYXABanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CYXABanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointLeftRightMargin = CYXABannerUtil.dp2px(context, 3);
        mPointTopBottomMargin = CYXABannerUtil.dp2px(context, 6);
        mPointContainerLeftRightPadding = CYXABannerUtil.dp2px(context, 10);
        mTipTextSize = CYXABannerUtil.sp2px(context, 10);
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#44aaaaaa"));
        mTransitionEffect = TransitionEffect.Default;
        mNumberIndicatorTextSize = CYXABannerUtil.sp2px(context, 10);
    }
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.ic_gf_default_photo);
        ...
        }else if(attr == R.styleable.BGABanner_banner_isIndicatorVisibility){
            mIsIndicatorVisibility=typedArray.getBoolean(attr, mIsIndicatorVisibility);
        }
    }

    private void initView(Context context) {
        RelativeLayout pointContainerRl = new RelativeLayout(context);
        if (!mIsIndicatorVisibility){
            pointContainerRl.setVisibility(GONE);
        }else{
            pointContainerRl.setVisibility(VISIBLE);
        }
        ...
        if (mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = CYXABannerUtil.getItemImageView(context, mPlaceholderDrawableResId);
    ...
    public SimpleDraweeView getItemImageView(int position) {
    ...
    public CYXAViewPager getViewPager() {
        return mViewPager;
    }
    ...
    private void initViewPager() {
        ...
        mViewPager = new CYXAViewPager(getContext());
    ...
    public void setTransitionEffect(TransitionEffect effect) {
        ...
        if (mViewPager != null) {
            initViewPager();
            if (mHackyViews == null) {
                CYXABannerUtil.resetPageTransformer(mViews);
            } else {
                CYXABannerUtil.resetPageTransformer(mHackyViews);
            }
        }
    }
            ...
            if (mOnItemClickListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mOnItemClickListener.onBannerItemClick(CYXABanner.this, view, mModels == null ? null : mModels.get(finalPosition), finalPosition);
                    }
                });
            }

            if (mAdapter != null) {
                mAdapter.fillBannerItem(CYXABanner.this, view, mModels == null ? null : mModels.get(finalPosition), finalPosition);
            }
    ...
    private static class AutoPlayTask implements Runnable {
        private final WeakReference<CYXABanner> mBanner;

        private AutoPlayTask(CYXABanner banner) {
            mBanner = new WeakReference<>(banner);
        }

        @Override
        public void run() {
            CYXABanner banner = mBanner.get();
            if (banner != null) {
    ...
    public interface OnItemClickListener {
        void onBannerItemClick(CYXABanner banner, View view, Object model, int position);
    }

    public interface Adapter {
        void fillBannerItem(CYXABanner banner, View view, Object model, int position);
    }
}