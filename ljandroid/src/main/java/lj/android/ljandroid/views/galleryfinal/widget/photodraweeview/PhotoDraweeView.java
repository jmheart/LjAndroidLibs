package lj.android.ljandroid.views.galleryfinal.widget.photodraweeview;
...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    public void setPhotoUri(Uri uri,Context context,Drawable defaultDrawable,int width,int height) {
        setPhotoUri(uri, context, defaultDrawable,width, height,0);
    }
    public void setPhotoUri(Uri uri, @Nullable Context context,Drawable defaultDrawable, final  int width,final int height,int type) {
