...
public class CoreConfig {
    ...
    private CoreConfig(Builder builder) {
        ...
        if ( takePhotoFolder == null ) {
            takePhotoFolder = new File(Environment.getExternalStorageDirectory(), "/DCIM/" + "cyx/image/");
        }
        if(!takePhotoFolder.exists()) {
            takePhotoFolder.mkdirs();
        }
        if ( editPhotoCacheFolder == null ) {
            editPhotoCacheFolder = new File(Environment.getExternalStorageDirectory() + "/caiyixiu/edittemp/");
        }
