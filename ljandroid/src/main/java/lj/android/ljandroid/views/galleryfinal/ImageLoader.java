...
public interface ImageLoader extends Serializable{
    ...
    void displayImage(Activity activity, String path, PhotoDraweeView imageView, Drawable defaultDrawable, int width, int height);
    void displayImageFromRes(Activity activity, String path, GFImageView imageView, Drawable defaultDrawable, int width, int height, int position);
