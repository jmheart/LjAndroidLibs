 ...
 */
public class CYXAViewPager extends ViewPager {
    private boolean mAllowUserScrollable = true;
    private AutoPlayDelegate mAutoPlayDelegate;

    public CYXAViewPager(Context context) {
        super(context);
    }

    public CYXAViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setPageChangeDuration(int duration) {
        try {
            ...
            scrollerField.set(this, new CYXABannerScroller(getContext(), duration));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
