package lj.android.ljandroid.views.scollview;

/**
 * Created by liujie on 2016/5/16.
 */
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                clear0();
                /*下拉刷新，到下拉的距离达到一定的值才刷新*/
                if (mIRefresh!=null&&isRefresh){
                    mIRefresh.onRefresh();
                    isRefresh=false;
                }
                LogUtil.i("MotionEvent-->>ACTION_UP"+Y);
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                LogUtil.i("MotionEvent-->>ACTION_MOVE"+deltaY);
                if (!isCount) {
                    deltaY = 0; // 在这里要归0.
                }
                y = nowY;
